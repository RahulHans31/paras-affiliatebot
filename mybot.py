...
bot = telebot.TeleBot("6032953341:AAERglkseLBpWRJ20T__vA-SNac6neEWUQ4")
affiliate_id = "foreverdeals01-21"
...
def encode_url(message):
    ...
    for amazon_link in links:
        ...
        if affiliate_link:
            ...
            encoded_url = "https://www.tricksbazzar.com/p/track-url.html?trackurl=" + affiliate_link
